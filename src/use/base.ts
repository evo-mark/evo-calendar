import { type ExtractPropTypes, type PropType, computed, inject, provide } from 'vue';
...
export const propsDef = {
	...
	isDark: {
		type: [Boolean, String, Object] as PropType<boolean | 'system' | DarkModeClassConfig>,
...
export function useBase() {
	...
	throw new Error('Base context missing. Please verify this component is nested within a valid context provider.');
}
