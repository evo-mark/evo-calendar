<template>
	<div class="vc-time-picker" :class="[{ 'vc-invalid': !isValid, 'vc-attached': !isTimeMode }]">
		...
		<div class="vc-time-select-group">
			...
			<BaseSelect v-model.number="hours" :options="hourOptions" class="vc-time-select-hours" align-right />
