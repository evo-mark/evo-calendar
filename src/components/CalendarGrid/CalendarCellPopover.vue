<template>
	<Popover :id="popoverId" ref="popoverRef" :class="[`vc-${color}`, `vc-${displayMode}`]" @after-hide="onAfterHide">
		<CalendarEventEdit v-if="event" :event="event" v-bind="$attrs" @close="hide" />
	</Popover>
</template>
...
import { type PopoverOptions, hidePopover, showPopover } from '../../utils/popovers';
