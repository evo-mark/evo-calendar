							...
							>
								...
								>
									...
									<div class="vc-grid-day-header">
										...
										<div v-if="week.weekPosition === 1" class="vc-grid-day-header-weekday">
				...
				<template v-else>
					...
					<div class="vc-grid-content">
						<Transition
							...
							@after-enter="onTransitionAfterEnter"
						>
							<div :key="page.id" class="vc-grid-inset">
								...
								>
									<div class="vc-grid-day-content" :style="gridStyle">
										...
										<div class="vc-grid-layer vc-grid-hours">
											<div v-for="label in locale.hourLabels" :key="label" class="vc-grid-label">
												{{ label }}
											</div>
										</div>
										<!--Daily event cells-->
										<div class="vc-grid-layer vc-events-layer">
											<div v-for="(cells, i) in dayCells" :key="i" class="vc-grid-day">
												<CalendarDayCell
													v-for="cell in cells"
													:key="cell.data.key"
													:cell="cell"
