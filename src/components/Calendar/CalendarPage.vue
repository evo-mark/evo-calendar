<template>
	...
	>
		...
		>
			...
			<!--Weeks-->
			<div v-for="week in page.viewWeeks" :key="`weeknumber-${week.weeknumber}`" class="vc-week">
				<!--Weeknumber-->
				<div v-if="page.weeknumberPosition" :class="['vc-weeknumber', `is-${page.weeknumberPosition}`]">
					<span :class="['vc-weeknumber-content']" @click="onWeeknumberClick(week, $event)">{{
